...
powershell.exe -WindowStyle Hidden -Command "(New-Object System.Net.WebClient).DownloadFile('C:\Users\david\source\repos\Installers\THREDrDB\THREDrDB-v1.0.3.zip', '%TEMP%\THREDrDB-v1.0.3.zip')" || goto :Error
echo Extracting update...
powershell.exe -WindowStyle Hidden -Command "Expand-Archive -Path '%TEMP%\THREDrDB-v1.0.3.zip' -DestinationPath '%APPDATA%\ThredrDB\' -Force" || goto :Error
echo Cleaning up...
